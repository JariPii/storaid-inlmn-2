...
const StatsCard = ({ className }: StatsCardProps) => {
  return (
    <div
      className={cn(
        // 'bg-(--clr-secondary) flex items-center justify-center px-12 py-4 rounded-[10px] gap-8',
        'bg-(--clr-secondary) grid grid-cols-3 place-content-between px-8 py-4 rounded-[10px] gap-8',
        className
      )}
    >
